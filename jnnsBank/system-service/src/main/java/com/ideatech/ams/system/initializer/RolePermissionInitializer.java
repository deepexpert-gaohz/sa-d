...
@Component
public class RolePermissionInitializer extends AbstractDataInitializer {
    ...
    protected void doInit() throws Exception {
        ...
        PermissionPo carrierOperatorSearchPermission = new PermissionPo("carrierOperator_search", "运营商校验", customerSearchPermission.getId(), "../ui/search/carrierOperatorSearch.html", "fa-id-badge", "menu", 600L, "GET", "运营商校验", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(carrierOperatorSearchPermission);
        PermissionPo idCardSearchPermission = new PermissionPo("idCard_search", "联网身份核查", customerSearchPermission.getId(), "../ui/search/idCardSearch.html", "fa-address-card-o", "menu", 700L, "GET", "联网身份核查", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(idCardSearchPermission);
        ...
        /**
         * 企业联网核查 orderNum:35000-49999
         */
        PermissionPo networkVerifyPermission = new PermissionPo("networkVerify_manager", "企业联网核查", -1L, "", "fa-bank", "menu", 35000L, "GET", "企业联网核查", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(networkVerifyPermission);

        PermissionPo networkVerifyOfPhoneNumber = new PermissionPo("networkVerify_phoneNumber", "手机号码联网核查", networkVerifyPermission.getId(), "../ui/networkVerify/phoneNumberLog.html", "fa-address-book-o", "menu", 100L, "GET", "手机号码联网核查", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(networkVerifyOfPhoneNumber);

        PermissionPo networkVerifyOfTaxInformation = new PermissionPo("networkVerify_taxInformation", "纳税信息联网核查", networkVerifyPermission.getId(), "../ui/networkVerify/taxInformationLog.html", "fa-money", "menu", 200L, "GET", "纳税信息联网核查", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(networkVerifyOfTaxInformation);

        PermissionPo networkVerifyOfBusinessAcceptTime = new PermissionPo("networkVerify_businessAcceptTime", "业务受理时间查询", networkVerifyPermission.getId(), "../ui/networkVerify/businessAcceptTimeLog.html", "fa-calendar-check-o", "menu", 300L, "GET", "业务受理时间查询", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(networkVerifyOfBusinessAcceptTime);

        PermissionPo networkVerifyOfRegisterInformation = new PermissionPo("networkVerify_registerInformation", "登记信息联网核查", networkVerifyPermission.getId(), "../ui/networkVerify/registerInformationLog.html", "fa-sitemap", "menu", 400L, "GET", "登记信息联网核查", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(networkVerifyOfRegisterInformation);

        PermissionPo networkVerifyOfOpenRevokeStateFeedback = new PermissionPo("networkVerify_openRevokeState", "开销户状态反馈", networkVerifyPermission.getId(), "../ui/networkVerify/openRevokeStateFeedbackLog.html", "fa-mail-reply-all", "menu", 500L, "GET", "开销户状态反馈", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(networkVerifyOfOpenRevokeStateFeedback);

        PermissionPo networkVerifyOfBusinessAcceptTimeNotice = new PermissionPo("networkVerify_businessAcceptTimeNotice", "业务受理时间通知", networkVerifyPermission.getId(), "../ui/networkVerify/businessAcceptTimeNotice.html", "fa-envelope-open", "menu", 1000L, "GET", "业务受理时间通知", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(networkVerifyOfBusinessAcceptTimeNotice);

        PermissionPo networkVerifyOfAnnouncementInformation = new PermissionPo("networkVerify_announcementInformation", "公告信息", networkVerifyPermission.getId(), "../ui/networkVerify/announcementInformation.html", "fa-file-text-o", "menu", 700L, "GET", "公告信息", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(networkVerifyOfAnnouncementInformation);

        PermissionPo networkVerifyOfInstitutionAbnormal = new PermissionPo("networkVerify_institutionAbnormal", "机构异常核查通知", networkVerifyPermission.getId(), "../ui/networkVerify/institutionAbnormalNotice.html", "fa-institution", "menu", 800L, "GET", "机构异常核查通知", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(networkVerifyOfInstitutionAbnormal);

        PermissionPo networkVerifyOfEnterpriseAbnormal = new PermissionPo("networkVerify_enterpriseAbnormal", "企业异常核查通知", networkVerifyPermission.getId(), "../ui/networkVerify/enterpriseAbnormalNotice.html", "fa-building-o", "menu", 900L, "GET", "企业异常核查通知", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(networkVerifyOfEnterpriseAbnormal);





        PermissionPo customerSmartManagerPermission = new PermissionPo("customerSmart_manager", "客户智能管理", -1L, "", "fa-users", "menu", 40000L, "GET", "客户智能管理", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(customerSmartManagerPermission);
        PermissionPo customerManagerPermission = new PermissionPo("customer_manager", "客户信息管理", customerSmartManagerPermission.getId(), "../ui/customer/list.html", "fa-handshake-o", "menu", 100L, "GET", "客户信息管理", Boolean.TRUE, Boolean.FALSE);
        ...
        PermissionPo companyAccountsPermission = new PermissionPo("companyAccounts_manager", "对公业务管理", acctPermission.getId(), "../ui/company/companyAccounts.html?whiteList=0", "fa-address-card-o", "menu", 300L, "GET", "对公报备管理", Boolean.TRUE, Boolean.FALSE);
        ...
        PermissionPo todayPbcDataPermission = new PermissionPo("todayPbcData", "当日报送数据", acctPermission.getId(), "../ui/company/todayPbcData.html", "fa-balance-scale", "menu", 500L, "GET", "当日报送数据", Boolean.TRUE, Boolean.FALSE);
        ...
        PermissionPo statisticsSettlePermission = new PermissionPo("statistics_settle", "审核情况表", customerReportPermission.getId(), "../ui/company/businessSettleApproval.html", "fa-bar-chart", "menu", 100L, "GET", "账户信息统计", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(statisticsSettlePermission);
        PermissionPo statisticsUnitInventoryPermission = new PermissionPo("statistics_UnitInventory", "单位存量报表", customerReportPermission.getId(), "../ui/company/businessUnitInventory.html", "fa-bar-chart", "menu", 100L, "GET", "账户信息统计", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(statisticsUnitInventoryPermission);
        PermissionPo statisticsBankBranchPermission = new PermissionPo("statistics_BankBranch", "银行网点分布情况表", customerReportPermission.getId(), "../ui/company/businessBankBranch.html", "fa-bar-chart", "menu", 100L, "GET", "账户信息统计", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(statisticsBankBranchPermission);
        PermissionPo statisticsSunitStockPermission = new PermissionPo("statistics_SunitStock", "单位存数量", customerReportPermission.getId(), "../ui/company/businessStatisticSunitStock.html", "fa-bar-chart", "menu", 100L, "GET", "账户信息统计", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(statisticsSunitStockPermission);
        ...
        PermissionPo statisticsAnalysisAccountPermission = new PermissionPo("statistics_analysis_account", "账户数量监测分析", customerReportPermission.getId(), "../ui/reportForm/list.html", "fa-table", "menu", 302L, "GET", "账户数量统计", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(statisticsAnalysisAccountPermission);
        ...
        PermissionPo imageCustomerPermission = new PermissionPo("image_customer", "客户影像信息", imagePermission.getId(), "../ui/imageInfo/customerImageManager.html", "fa-user", "menu", 100L, "GET", "客户影像信息", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(imageCustomerPermission);
        PermissionPo imageAccountPermission = new PermissionPo("image_account", "账户影像信息", imagePermission.getId(), "../ui/imageInfo/accountImageManager.html", "fa-address-card-o", "menu", 200L, "GET", "账户影像信息", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(imageAccountPermission);
        PermissionPo imageBillPermission = new PermissionPo("image_bill", "业务影像信息", imagePermission.getId(), "../ui/imageInfo/billImageManager.html", "fa-book", "menu", 300L, "GET", "业务影像信息", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(imageBillPermission);

        PermissionPo imageSyncPermission = new PermissionPo("image_sync", "影像报送管理", imagePermission.getId(), "../ui/imageInfo/billImageSyncManager.html", "fa fa-exchange", "menu", 301L, "GET", "影像报送管理", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(imageSyncPermission);

        PermissionPo imageVideoPermission = new PermissionPo("image_video", "双录视频管理", imagePermission.getId(), "../ui/imageInfo/videoList.html", "fa fa-file-video-o", "menu", 302L, "GET", "双录视频管理", Boolean.TRUE, Boolean.FALSE);
//        saveAndAddtoList(imageVideoPermission); 新项目默认启用新页面

        PermissionPo imageVideoPermissionV2 = new PermissionPo("image_video_v2", "双录视频管理", imagePermission.getId(), "../ui/imageInfo/videoList.v2.html", "fa fa-file-video-o", "menu", 302L, "GET", "双录视频管理v2", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(imageVideoPermissionV2);

        PermissionPo dualRecordAcceptance = new PermissionPo("image_video_accept", "双录受理", imagePermission.getId(), "../ui/imageInfo/blank.html", "fa fa-video-camera", "menu", 303L, "GET", "双录受理", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(dualRecordAcceptance);
        ...
        PermissionPo keyPermission = new PermissionPo("system_kyc_monitor", "客户尽调统计", systemMonitorPermission.getId(), "../ui/proof/kyclist.html", "fa fa-link", "menu", 201L, "GET", "客户尽调统计", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(keyPermission);

        PermissionPo pricePermission = new PermissionPo("system_price_monitor", "第三方数据查询统计", systemMonitorPermission.getId(), "../ui/proof/moneyList.html", "fa fa-server", "menu", 202L, "GET", "第三方数据查询统计", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(pricePermission);
        ...
        PermissionPo userTracePermission = new PermissionPo("sys_trace_manager", "用户操作记录", sysMgtPermission.getId(), "../ui/trace/list.html", "fa-th-list", "menu", 1500L, "GET", "操作记录管理", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(userTracePermission);

        PermissionPo syncHistoryPermission = new PermissionPo("sync_history", "报送监管", -1L, "", "fa fa-sitemap", "menu", 150000L, "GET", "报送监管", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(syncHistoryPermission);
        PermissionPo syncHistoryAmsPermission = new PermissionPo("sync_history_ams", "人行账管报送监管", syncHistoryPermission.getId(), "../ui/syncHistory/list.html?syncType=AMS", "fa fa-university", "menu", 150001L, "GET", "人行账管报送监管", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(syncHistoryAmsPermission);
        PermissionPo syncHistoryEccsPermission = new PermissionPo("sync_history_eccs", "机构信用代码证报送监管", syncHistoryPermission.getId(), "../ui/syncHistory/list.html?syncType=ECCS", "fa fa-book", "menu", 150002L, "GET", "机构信用代码证报送监管", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(syncHistoryEccsPermission);
        PermissionPo syncHistoryImsPermission = new PermissionPo("sync_history_ims", "影像报送监管", syncHistoryPermission.getId(), "../ui/syncHistory/list.html?syncType=IMS", "fa fa-file-image-o", "menu", 150003L, "GET", "影像报送监管", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(syncHistoryImsPermission);

        //按钮权限

        //首页区块权限
        PermissionPo noticeManagerBtnPermission = new PermissionPo("noticeManager_btn", "公告管理", indexPermission.getId(), "../ui/about.html", "", "button", 40L, "GET", "", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(noticeManagerBtnPermission);
        ...
        PermissionPo abnormalStatisticsDivPermission = new PermissionPo("abnormalStatistics_div", "企业风险异动数据", indexPermission.getId(), "../ui/about.html", "", "button", 52L, "GET", "企业风险异动数据", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(abnormalStatisticsDivPermission);
        PermissionPo abnormalAllDivPermission = new PermissionPo("abnormalAll_div", "企业异动总数", indexPermission.getId(), "../ui/about.html", "", "button", 53L, "GET", "企业异动总数", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(abnormalAllDivPermission);
        PermissionPo illegalDivPermission = new PermissionPo("illegal_div", "严重违法数", indexPermission.getId(), "../ui/about.html", "", "button", 54L, "GET", "严重违法数", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(illegalDivPermission);
        PermissionPo changeMessDivPermission = new PermissionPo("changeMess_div", "经营异常数", indexPermission.getId(), "../ui/about.html", "", "button", 55L, "GET", "经营异常数", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(changeMessDivPermission);
        PermissionPo businessExpiresDivPermission = new PermissionPo("businessExpires_div", "营业到期数", indexPermission.getId(), "../ui/about.html", "", "button", 56L, "GET", "营业到期数", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(businessExpiresDivPermission);
        PermissionPo abnormalStateDivPermission = new PermissionPo("abnormalState_div", "工商异常状态数", indexPermission.getId(), "../ui/about.html", "", "button", 57L, "GET", "工商异常状态数", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(abnormalStateDivPermission);
        PermissionPo changedDivPermission = new PermissionPo("changed_div", "工商登记信息异动数", indexPermission.getId(), "../ui/about.html", "", "button", 58L, "GET", "工商登记信息异动数", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(changedDivPermission);
        ...
        PermissionPo downAccountBtnPermission = new PermissionPo("account:down_account", "账户信息导出", companyAccountsPermission.getId(), "../ui/company/companyAccounts.html", "", "button", 133L, "GET", "", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(downAccountBtnPermission);
        ...
        //基本户销户校验跳过按钮
        PermissionPo jibenRevokeIgnoreBtnPermission = new PermissionPo("account:revoke_jibenIgnore", "基本户销户校验跳过按钮", companyAccountsPermission.getId(), "../ui/company/companyAccounts.html", "", "button", 135L, "GET", "基本户销户校验跳过按钮", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(jibenRevokeIgnoreBtnPermission);
...
//        saveAndAddtoList(illegalEditPermission);
        ...
        PermissionPo annualCompareFieldsConfigBtnPermission = new PermissionPo("annual:compareFields_config", "比对字段配置", annualTaskPermission.getId(), "../ui/annualcheck/page.html", "", "button", 149L, "GET", "", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(annualCompareFieldsConfigBtnPermission);
        ...
        //核心数据重新采集  20190722
        PermissionPo annualFailRecollectCoreBtnPermission = new PermissionPo("annual:fail_recollectCore", "核心失败记录重新采集", annualTaskPermission.getId(), "../ui/annualcheck/core.html", "", "button", 151L, "GET", "", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(annualFailRecollectCoreBtnPermission);
        ...
        PermissionPo annualHandleBtnPermission = new PermissionPo("annual:handle", "年检处理", annualTaskPermission.getId(), "../ui/annualcheck/page.html", "", "button", 155L, "GET", "", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(annualHandleBtnPermission);
        PermissionPo annualAgainBtnPermission = new PermissionPo("annual:again", "重新年检", annualTaskPermission.getId(), "../ui/annualcheck/page.html", "", "button", 155L, "GET", "", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(annualAgainBtnPermission);
        PermissionPo annualBatchDelBtnPermission = new PermissionPo("annual:batch_delete", "批量删除", annualTaskPermission.getId(), "../ui/annualcheck/page.html", "", "button", 155L, "GET", "", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(annualBatchDelBtnPermission);

        //无需年检
        PermissionPo annualBatchNoCheckPermission = new PermissionPo("annual:noCheckAnnual", "无需年检", annualTaskPermission.getId(), "../ui/annualcheck/page.html", "", "button", 155L, "GET", "", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(annualBatchNoCheckPermission);

        PermissionPo annualReCompareBtnPermission = new PermissionPo("annual:reCompare", "重新比对", annualTaskPermission.getId(), "../ui/annualcheck/page.html", "", "button", 0L, "GET", "", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(annualReCompareBtnPermission);
        PermissionPo annualSysSubmitBtnPermission = new PermissionPo("annual:success_submit", "系统年检成功提交人行", annualTaskPermission.getId(), "../ui/annualcheck/page.html", "", "button", 0L, "GET", "系统年检成功提交人行", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(annualSysSubmitBtnPermission);
        PermissionPo annualManualSubmitBtnPermission = new PermissionPo("annual:manualSuccess_submit", "手工处理成功提交人行", annualTaskPermission.getId(), "../ui/annualcheck/page.html", "", "button", 0L, "GET", "手工处理成功提交人行", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(annualManualSubmitBtnPermission);
...
//        saveAndAddtoList(customerAbnormalManagerHistoryPermission);
        ...
        PermissionPo organAreaPbcuditPermission = new PermissionPo("organ:area_pbc_audit", "地方人行设置", sysOrgPermission.getId(), "../ui/organization/list.html", "", "button", 178L, "GET", "", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(organAreaPbcuditPermission);
        ...
        //增加删除按钮
        PermissionPo zhsqDelBtnPermission = new PermissionPo("account:btn_zhsq_delete", "账户申请删除按钮", companyAccountsPermission.getId(), "../ui/company/zhsqAccount.html", "", "button", 179L, "GET", "", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(zhsqDelBtnPermission);

        PermissionPo dshDelBtnPermission = new PermissionPo("account:btn_dsh_delete", "待审核删除按钮", companyAccountsPermission.getId(), "../ui/company/dshAccount.html", "", "button", 180L, "GET", "", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(dshDelBtnPermission);

        PermissionPo dsbDelBtnPermission = new PermissionPo("account:btn_dsb_delete", "待上报删除按钮", companyAccountsPermission.getId(), "../ui/company/dsbAccount.html", "", "button", 181L, "GET", "", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(dsbDelBtnPermission);
        ...
        PermissionPo videoBtN = new PermissionPo("video:create","双录",imageVideoPermission.getId(),"../ui/imageInfo/videoList.html","","button",0L,"GET","双录", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(videoBtN);

        PermissionPo btnVideoRecord = new PermissionPo("video:btnVideoRecord","发起临柜双录",imageVideoPermission.getId(),"../ui/imageInfo/videoOpen.html","","button",1L,"GET","发起临柜双录", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(btnVideoRecord);

        PermissionPo btnVideoUpload = new PermissionPo("video:btnVideoUpload","本地上传",imageVideoPermission.getId(),"../ui/imageInfo/videoOpen.html","","button",2L,"GET","本地上传", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(btnVideoUpload);

        PermissionPo btnVideoSend = new PermissionPo("video:btnVideoSend","上传影像平台",imageVideoPermission.getId(),"../ui/imageInfo/videoOpen.html","","button",3L,"GET","上传影像平台", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(btnVideoSend);

        PermissionPo btnMessageSend = new PermissionPo("video:btnMessageSend","发送远程双录短信",imageVideoPermissionV2.getId(),"../ui/imageInfo/videoOpen.v2.html","","button",1L,"GET","发送远程双录短信", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(btnMessageSend);

        PermissionPo btnVideoExport = new PermissionPo("video:export_excel","结果导出",imageVideoPermissionV2.getId(),"../ui/imageInfo/videoList.v2.html","","button",2L,"GET","结果导出", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(btnVideoExport);

        PermissionPo btnVideoRecordV2 = new PermissionPo("video:btnVideoRecordV2","发起临柜双录",imageVideoPermissionV2.getId(),"../ui/imageInfo/videoOpen.v2.html","","button",3L,"GET","发起临柜双录V2", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(btnVideoRecordV2);

        PermissionPo btnVideoUploadV2 = new PermissionPo("video:btnVideoUploadV2","本地上传",imageVideoPermissionV2.getId(),"../ui/imageInfo/videoOpen.v2.html","","button",4L,"GET","本地上传V2", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(btnVideoUploadV2);

        PermissionPo syncButton = new PermissionPo("account:btn_syncImage","影像上报人行",companyAccountsPermission.getId(),"../ui/company/companyAccounts.html?whiteList=0","","button",0L,"GET","影像上报人行", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(syncButton);

        PermissionPo scanImageButton = new PermissionPo("image:btn_scanImage","扫描影像",companyAccountsPermission.getId(),"../ui/company/companyAccounts.html?whiteList=0","","button",0L,"GET","扫描影像", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(scanImageButton);

        PermissionPo sendImageButton = new PermissionPo("image:btn_sendImage","传送影像平台",companyAccountsPermission.getId(),"../ui/company/companyAccounts.html?whiteList=0","","button",0L,"GET","传送影像平台", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(sendImageButton);

        PermissionPo btn_video_edit = new PermissionPo("account:btn_video_edit","双录编辑",companyAccountsPermission.getId(),"../ui/company/companyAccounts.html?whiteList=0","","button",0L,"GET","双录编辑", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(btn_video_edit);

        //企业联网核查按钮
        PermissionPo networkVerifyOfPhoneNumberAdd = new PermissionPo("network:phoneNumber-add","手机号码联网核查新建查询",networkVerifyOfPhoneNumber.getId(),"../ui/networkVerify/phoneNumberLog.html","","button",1L,"GET","手机号码联网核查新建查询", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(networkVerifyOfPhoneNumberAdd);

        PermissionPo networkVerifyOfPhoneNumberFeedback = new PermissionPo("network:phoneNumber-feedback","手机号码联网核查疑义反馈",networkVerifyOfPhoneNumber.getId(),"../ui/networkVerify/phoneNumberLog.html","","button",2L,"GET","手机号码联网核查疑义反馈", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(networkVerifyOfPhoneNumberFeedback);

        PermissionPo networkVerifyOfPhoneNumberFeedbackLog = new PermissionPo("network:phoneNumber-feedback-log","手机号码联网核查反馈记录",networkVerifyOfPhoneNumber.getId(),"../ui/networkVerify/phoneNumberLog.html","","button",3L,"GET","手机号码联网核查反馈记录", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(networkVerifyOfPhoneNumberFeedbackLog);

        PermissionPo networkVerifyOfTaxInformationAdd = new PermissionPo("network:taxInformation-add","纳税信息联网核查新建查询",networkVerifyOfTaxInformation.getId(),"../ui/networkVerify/taxInformationLog.html","","button",1L,"GET","纳税信息联网核查新建查询", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(networkVerifyOfTaxInformationAdd);

        PermissionPo networkVerifyOfTaxInformationFeedback = new PermissionPo("network:taxInformation-feedback","纳税信息联网核查疑义反馈",networkVerifyOfTaxInformation.getId(),"../ui/networkVerify/taxInformationLog.html","","button",2L,"GET","纳税信息联网核查疑义反馈", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(networkVerifyOfTaxInformationFeedback);

        PermissionPo networkVerifyOfTaxInformationFeedbackLog = new PermissionPo("network:taxInformation-feedback-log","纳税信息联网核查反馈记录",networkVerifyOfTaxInformation.getId(),"../ui/networkVerify/taxInformationLog.html","","button",3L,"GET","纳税信息联网核查反馈记录", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(networkVerifyOfTaxInformationFeedbackLog);

        PermissionPo networkVerifyOfBusinessAcceptTimeAdd = new PermissionPo("network:businessAcceptTime-add","业务受理时间查询新建查询",networkVerifyOfBusinessAcceptTime.getId(),"../ui/networkVerify/businessAcceptTimeLog.html","","button",1L,"GET","业务受理时间查询新建查询", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(networkVerifyOfBusinessAcceptTimeAdd);

        PermissionPo networkVerifyOfRegisterInformationAdd = new PermissionPo("network:registerInformation-add","登记信息联网核查新建查询",networkVerifyOfRegisterInformation.getId(),"../ui/networkVerify/registerInformationLog.html","","button",1L,"GET","登记信息联网核查新建查询", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(networkVerifyOfRegisterInformationAdd);

        PermissionPo networkVerifyOfRegisterInformationFeedback = new PermissionPo("network:registerInformation-feedback","登记信息联网核查疑义反馈",networkVerifyOfRegisterInformation.getId(),"../ui/networkVerify/registerInformationLog.html","","button",2L,"GET","登记信息联网核查疑义反馈", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(networkVerifyOfRegisterInformationFeedback);

        PermissionPo networkVerifyOfRegisterInformationFeedbackLog = new PermissionPo("network:registerInformation-feedback-log","登记信息联网核查反馈记录",networkVerifyOfRegisterInformation.getId(),"../ui/networkVerify/registerInformationLog.html","","button",3L,"GET","登记信息联网核查反馈记录", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(networkVerifyOfRegisterInformationFeedbackLog);

        PermissionPo networkVerifyOfOpenRevokeStateFeedbackAdd = new PermissionPo("network:openRevokeState-feedback","开销户状态反馈新建查询",networkVerifyOfOpenRevokeStateFeedback.getId(),"../ui/networkVerify/openRevokeStateFeedbackLog.html","","button",1L,"GET","开销户状态反馈新建查询", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(networkVerifyOfOpenRevokeStateFeedbackAdd);

        PermissionPo networkVerifyOfAnnouncementInformationConfirmAdd = new PermissionPo("network:announcementInformation-confirm","公告信息确认",networkVerifyOfAnnouncementInformation.getId(),"../ui/networkVerify/announcementInformation.html","","button",1L,"GET","公告信息确认", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(networkVerifyOfAnnouncementInformationConfirmAdd);

        PermissionPo networkVerifyOfAnnouncementInformationConfirmLog = new PermissionPo("network:announcementInformation-confirm-log","公告信息确认记录",networkVerifyOfAnnouncementInformation.getId(),"../ui/networkVerify/announcementInformation.html","","button",2L,"GET","公告信息确认", Boolean.TRUE, Boolean.FALSE);
        saveAndAddtoList(networkVerifyOfAnnouncementInformationConfirmLog);
