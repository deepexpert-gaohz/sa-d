...
@Data
public class CustomerPublicMidInfo extends BaseMaintainableDto {
    ...
    private Set<RelateCompanyMidInfo> relateCompanysMid;
    ...
    private Set<CompanyPartnerMidInfo> companyPartnersMid;
