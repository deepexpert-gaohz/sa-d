...
@Data
@Entity
@Table(name = "BREAKLAW_INFO")
public class BreakLawInfo  extends BaseMaintainablePo implements Serializable {

    /**
     * 序列化ID,缓存需要
     */
    private static final long serialVersionUID = 54541121212135342L;
    public static String baseTableName = "YD_BREAKLAW_INFO";
