package com.ideatech.ams.dto.gmsp;
...
import com.ideatech.ams.service.NoSensitiveObj;
...
public class GMSP {
     ...
     * 人行上报状态（0为上报，1为不上报）
     */
    private String acctAmsOpenType;

    /**
     * 机构信用代码上报状态（0为上报，1为不上报）
     */
    private String acctEccsOpenType;
...
//    @Column(length = 14)
    ...
    private String bingengDate;

//
//        t.setTelephone(SensitiveInfoUtils.mobilePhone(telephone));
//        t.setDepositorName(SensitiveInfoUtils.chineseName(depositorName));
//        t.setAcctName(SensitiveInfoUtils.chineseName(acctName));
//        t.setRegAddress(SensitiveInfoUtils.chineseName(regAddress));
//        t.setLegalIdcardNo(SensitiveInfoUtils.idCardNum(legalIdcardNo));
//        t.setLegalName(SensitiveInfoUtils.idCardNum(legalName));
