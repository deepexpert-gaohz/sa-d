...
@Component("systemSuccessAnnualResultProcessor")
public class SystemSuccessAnnualResultProcessor extends AbstractAnnualResultProcessor {
	...
	private void setParameter(AnnualResultDto annualResultInfo) {
		...
		annualResultInfo.setPbcSubmitStatuses(strs);
		annualResultInfo.setResult(ResultStatusEnum.PASS);
