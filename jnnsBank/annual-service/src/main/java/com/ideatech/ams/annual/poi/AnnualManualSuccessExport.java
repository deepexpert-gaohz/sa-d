 ...
 * @date 2019/4/25.
 */
public class AnnualManualSuccessExport implements IExcelExport<AnnualManualSuccessPoi> {

    List<AnnualManualSuccessPoi> poiList = new ArrayList<>();

    private String title = "手工处理成功";
    String[] headers = {"账号","企业名称","人行机构号","网点机构号", "异常状态","处理人","处理时间","账户性质"};
    ...
    @Override
    public List<AnnualManualSuccessPoi> getPoiList() {
        return this.poiList;
    }

    @Override
    public void setPoiList(List<AnnualManualSuccessPoi> data) {
        this.poiList = data;
    }
