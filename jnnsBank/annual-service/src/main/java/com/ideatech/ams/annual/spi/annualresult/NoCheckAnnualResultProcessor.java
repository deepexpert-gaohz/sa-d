...
@Component("noCheckAnnualResultProcessor")
public class NoCheckAnnualResultProcessor extends AbstractAnnualResultProcessor {
    @Autowired
    ...
    private void setParameter(AnnualResultDto annualResultInfo) {
        annualResultInfo.setResult(ResultStatusEnum.NO_CHECK_ANNUAL);
