 ...
 * @date 2019/4/25.
 */
public class AnnualSystemSuccessExport implements IExcelExport<AnnualSystemSuccessPoi> {

    List<AnnualSystemSuccessPoi> poiList = new ArrayList<>();

    private String title = "系统年检成功";
    String[] headers = {"账号","企业名称","人行机构号","网点机构号","年检报送结果","数据一致性","账户性质"};
    ...
    @Override
    public List<AnnualSystemSuccessPoi> getPoiList() {
        return this.poiList;
    }

    @Override
    public void setPoiList(List<AnnualSystemSuccessPoi> data) {
        this.poiList = data;
    }
