...
@Data
@Slf4j
public class BeneficiaryCollectionTaskExecutor implements Runnable {
    ...
    public BeneficiaryCollectionTaskExecutor(String batchNo) {
...
//                saicBeneficiaryDto.setIsSame(Boolean.FALSE);
                ...
                if (saicInfoBase != null) {
                    ...
                    log.info(coreBeneficiaryDto.getCustomerName() + "受益人采集查询工商数据保存进工商统计表......");
                    ...
                    SaicMonitorDto saicMonitorDto = new SaicMonitorDto();
                    log.info(coreBeneficiaryDto.getCustomerName() + "受益人采集查询工商数据为空保存进工商统计表......");
