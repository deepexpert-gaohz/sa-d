 ...
 * 核心采集数据
 * @author wanghongjie
 * @version 2018-08-07 11:28
 */
@Entity
@Table(name = "core_collection", indexes = {@Index(name = "core_collection_atid_idx",columnList = "annualTaskId")})
@Data
public class CoreCollection extends BaseMaintainablePo implements Serializable {
	private static final long serialVersionUID = -852160778423681156L;
	/**
	 * 客户
	 */
	@Column
