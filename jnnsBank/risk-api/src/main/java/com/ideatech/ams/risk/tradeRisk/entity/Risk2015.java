 ...
 */
@Entity
@Table(name = "risk_2015")
@Data
public class Risk2015 extends DealBase {
    @Comment("机构名称")
    ...
    @Comment("法人")
    @Column(name = "frdbmc", columnDefinition = " varchar(255) ")
    private String frdbmc;
    @Comment("证件号码")
    @Column(name = "zjhm", columnDefinition = " varchar(255) ")
    private String zjhm;
    @Comment("有效期")
    @Column(name = "yxq", columnDefinition = " varchar(255) ")
    private String yxq;
    @Comment("存款账号")
