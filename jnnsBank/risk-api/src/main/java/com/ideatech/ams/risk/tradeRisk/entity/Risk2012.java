...
/**
 * 短期内资金集中转入、分散转出，尤其是资金来汇往多个地区，多为单次交易
 *
 * @author liuz 20191031
 */
@Data
@Entity
@Table(name = "risk_2012")
public class Risk2012 extends DealBase {
    @Comment("机构名称")
    ...
    private String dfhm;
    @Comment("注册行政区划")
    @Column(name = "dfxzqh", columnDefinition = " varchar(255) ")
    private String dfxzqh;
    @Comment("交易渠道")
