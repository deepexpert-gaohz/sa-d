...
public class SM3Digest {
    ...
    {
        System.arraycopy(SM3Digest.xBuf, 0, SM3Digest.xBuf, 0, SM3Digest.xBuf.length);
        SM3Digest.xBufOff = SM3Digest.xBufOff;
        System.arraycopy(SM3Digest.V, 0, SM3Digest.V, 0, SM3Digest.V.length);
    }
     ...
     * @return
     */
    public static String SM3PassWord(String password){
    	 byte[] md = new byte[32];
    	 byte[] msg1 = password.getBytes();
    	 SM3Digest.update(msg1, 0, msg1.length);
         SM3Digest.doFinal(md, 0);
          String s = new String(HexBinary.encode(md));
