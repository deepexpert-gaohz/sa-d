...
@Entity
@Data
public class CompareResultSaicCheck extends BaseMaintainablePo {
    ...
    public CompareResultSaicCheck(Long compareTaskId,Long compareResultId,Long saicInfoId){
        this.compareTaskId = compareTaskId;
        this.compareResultId = compareResultId;
        this.saicInfoId = saicInfoId;
        this.illegal = false;
        this.changeMess = false;
        this.businessExpires = false;
        this.changed = false;
        this.abnormal = false;
        this.saicState = SaicStateEnum.UNKNOW;
        this.abnormalState = false;
    }

    public CompareResultSaicCheck(){ }
}
