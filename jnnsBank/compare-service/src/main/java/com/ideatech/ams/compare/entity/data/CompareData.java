package com.ideatech.ams.compare.entity.data;
...
@MappedSuperclass
@Data
public class CompareData extends BaseMaintainablePo {

    public static final String domainPackage = "com.ideatech.ams.compare.entity.data.";
