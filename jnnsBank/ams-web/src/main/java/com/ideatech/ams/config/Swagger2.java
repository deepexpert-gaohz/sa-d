...
public class Swagger2  extends WebMvcConfigurerAdapter implements EnvironmentAware {
	...
	public Docket createRestApi() {
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo())
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.ideatech"))
	...
	public void setEnvironment(Environment environment) {
		...
		this.creatName = propertyResolver.getProperty("swagger.biz.developer");
		this.serviceName = propertyResolver.getProperty("swagger.biz.name");
		this.description = propertyResolver.getProperty("swagger.biz.description");
	}
}
