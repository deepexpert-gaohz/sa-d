...
//            fos.close();
	...
	public String imageCode(HttpServletRequest request, HttpServletResponse response) throws Exception {
	 ...
	 String simpleCaptcha = "sessionImageCode";
	 String imageTime = "imageTime";
	 request.getSession().setAttribute(simpleCaptcha, verifyCode);
	 request.getSession().setAttribute(imageTime,new Date().getTime());
	 try {
		 outputImage(w, h, os, verifyCode);
