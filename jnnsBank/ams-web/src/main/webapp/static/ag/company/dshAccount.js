    ...
    if (apply.select(layer)) {
        ...
        $.get('../../allAccountPublic/checkSyncModel', '', function (result) {
            ...
            if (billType !== 'ACCT_REVOKE') {
                ...
                getBillIsBusy(billId, function (res) {
                    if (res.rel) {
                        ...
                        parent.tab.tabAdd({
                            ...
                            href: 'accttype/' + type + 'Open.html?billId=' + billId + '&billType=' + billType + '&buttonType=' + buttonType + '&syncEccs=' + syncEccs + '&updateType=' + updateType + "&pageCode=dshAccount"
                        });
                    }
                });
            } else {
                parent.tab.tabAdd({
                    title: '查看' + acctTypeMap[type] + '-' + name,
                    href: 'account/accountRevoke.html?billId=' + billId + '&buttonType=' + buttonType + '&syncEccs=' + syncEccs + '&updateType=' + updateType + '&acctNo=' + acctNo
                });
            }
        });
    }
