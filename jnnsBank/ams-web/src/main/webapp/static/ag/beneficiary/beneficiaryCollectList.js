...
layui.use(['form', 'layedit', 'laydate', 'loading', 'common'], function () {
	...
	$("#btn_download").on("click", function () {
		$("#downloadFrame").prop('src', "../attach/beneficiary_collect_template.xls");
		return false;
	});
	...
	$('#list').on('click', '.view', function () {
		...
		parent.tab.tabAdd({
			title: '受益人采集详情',
			href: '../ui/beneficiary/beneficiary_collect_detail.html?batchNo=' + batchNo
		});
		return false;
	});
