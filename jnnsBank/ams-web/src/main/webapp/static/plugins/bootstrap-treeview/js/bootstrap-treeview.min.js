!function (a, b, c, d) {
    ...
    g.prototype.init = function (b) {
        ...
        if (d && !d.state.disabled) {
            ...
            c.hasClass("expand-icon") ? (this.toggleExpandedState(d, f.options), this.render()) : c.hasClass("check-icon") ? (this.toggleCheckedState(d, f.options), this.render()) : (d.selectable ? this.toggleSelectedState(d, f.options) : this.toggleExpandedState(d, f.options), this.render())
        }
