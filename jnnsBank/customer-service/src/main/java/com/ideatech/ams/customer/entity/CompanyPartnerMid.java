 ...
 */
@Entity
@Table(name = "COMPANY_PARTNER_MID")
@Data
public class CompanyPartnerMid extends BaseMaintainablePo implements Serializable {
    ...
    public static String baseTableName = "YD_COMPANY_PARTNER_MID";
