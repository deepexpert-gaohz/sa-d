 ...
 */
@Entity
@Table(name = "CUSTOMER_PUBLIC_LOG",
        indexes = {@Index(name = "customer_public_log_ci_idx",columnList = "customerId")
                ,@Index(name = "customer_public_log_rbi_idx",columnList = "refBillId")})
@Data
public class CustomerPublicLog extends BaseMaintainablePo implements Serializable {

    /**
     * 序列化ID,缓存需要OrganFullId
     */
    private static final long serialVersionUID = 5454155825314635342L;
    public static String baseTableName = "YD_CUSTOMER_PUBLIC_LOG";
...
//
//
//    @OneToMany(mappedBy = "customerPublicLog")
//    private Set<RelateCompanyLog> relateCompanysLog;
//
//    /**
//     * 企业股东/高管信息历史
//     */
...
//
//    @OneToMany(mappedBy = "customerPublicLog")
//    private Set<CompanyPartnerLog> companyPartnersLog;
