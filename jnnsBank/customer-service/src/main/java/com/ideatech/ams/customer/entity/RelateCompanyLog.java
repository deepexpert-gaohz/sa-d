 ...
 */
@Entity
@Table(name = "RELATE_COMPANY_LOG")
@Data
public class RelateCompanyLog extends BaseMaintainablePo implements Serializable {
    ...
    public static String baseTableName = "YD_RELATE_COMPANY_LOG";
