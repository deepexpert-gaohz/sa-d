 ...
 */
@Entity
@Table(name = "COMPANY_PARTNER_LOG")
@Data
public class CompanyPartnerLog extends BaseMaintainablePo implements Serializable {
    ...
    public static String baseTableName = "YD_COMPANY_PARTNER_LOG";
     ...
     *
     *
     * @Column(length = 22) private Long logId;
     */
    /**
     * 伙伴ID
     */
    ...
    public void Validate() {
        // [日志ID]的必填验证
        /*
         * if (this.getLogId() == null) { throw new RuntimeException("[日志ID]不能为空"); }
         */
        // [伙伴ID]的必填验证
